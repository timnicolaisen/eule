...
namespace GUIManagement
{
    ...
    public class AccountController : BaseController
    {
        ...
        //Important! : DisvisionID will be automatically set to 1. 
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, DivisionID = 1 };
